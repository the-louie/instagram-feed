...
$sbi_photo_style_element = SB_Instagram_Display_Elements::get_sbi_photo_style_element( $post, $settings );
...
?>
<div class="sbi_item sbi_type_<?php echo esc_attr( $media_type ); ?><?php echo $classes; ?>" id="sbi_<?php echo esc_html( $post_id ); ?>" data-date="<?php echo esc_html( $timestamp ); ?>">
    <div class="sbi_photo_wrap">
        <a class="sbi_photo" href="<?php echo esc_url( $permalink ); ?>" target="_blank" rel="noopener" data-full-res="<?php echo esc_url( $media_full_res ); ?>" data-img-src-set="<?php echo esc_attr( wp_json_encode( $media_all_sizes_json ) ); ?>"<?php echo $sbi_photo_style_element; ?>>
            ...
            <img src="<?php echo $media_url; ?>" alt="<?php echo esc_attr( $img_alt ); ?>" width="200" height="200">
        </a>
    </div>
</div>